    ...
    return (
      ...
      >
        ...
        >
          ...
          <View style={styles.playButtonShineSmall} />
          <Feather 
          ...
          <View style={styles.secondaryButtons}>
            <View style={styles.partyDailyRow}>
              <Animated.View entering={FadeInUp.delay(650).springify()} style={[
                ...
                >
                  <LinearGradient
                    colors={[colors.secondary, colors.secondary + "CC", colors.secondary + "99"]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 0.5, y: 1 }}
...
const styles = StyleSheet.create({
  ...
  profileButton: {
    width: Math.min(46, SCREEN_WIDTH * 0.12),
    height: Math.min(46, SCREEN_WIDTH * 0.12),
    borderRadius: Math.min(23, SCREEN_WIDTH * 0.06),
    overflow: "hidden",
    elevation: 6,
    shadowColor: "#000",
  ...
  currencyContainer: {
    flexDirection: "row",
    gap: Math.min(Spacing.xs, SCREEN_WIDTH * 0.02),
  },
  currencyBadge: {
    flexDirection: "row",
    alignItems: "center",
    paddingHorizontal: Math.min(Spacing.md, SCREEN_WIDTH * 0.03),
    paddingVertical: Math.min(Spacing.sm, SCREEN_WIDTH * 0.02),
  ...
  content: {
    ...
    alignItems: "center",
    justifyContent: "center",
    paddingHorizontal: Math.min(Spacing.xl, SCREEN_WIDTH * 0.05),
  },
  logoWrapper: {
    position: "relative",
    alignItems: "center",
  ...
  logoGlow: {
    ...
    borderRadius: Math.min(90, SCREEN_WIDTH * 0.225),
